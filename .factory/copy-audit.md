...
(`text.trim().split(/\s+/)`). `Alt+R` and hyphenated terms therefore count as
one word. The automated copy-policy test recalculates every count and confirms
that the audited string exists in its named source.
...
| landing | 5 | Try it with sample data |
| landing | 6 | See highlighted captions before you install. |
| landing | 4 | Download unpacked Chrome extension |
| landing | 7 | Downloads a ZIP for Chrome Developer mode. |
| landing | 5 | Caption controls need no account. |
| landing | 7 | The demo works offline after one visit. |
| landing | 7 | All highlighting and replay tools are free. |
| landing | 2 | Caption preview |
...
| landing | 4 | Text before the colon |
| landing | 1 | Names |
| landing | 4 | Names in the line |
| landing | 2 | Sound cues |
| landing | 3 | Descriptions in brackets |
| landing | 3 | Saved word: Gate |
...
| landing | 3 | Choose your cues |
| landing | 10 | Mark names, speaker labels, sound cues, or a saved word. |
...
| landing | 6 | How do I install the download? |
| landing | 2 | Unzip it. |
| landing | 2 | Open chrome://extensions. |
| landing | 12 | Turn on Developer mode, choose “Load unpacked,” then select the unzipped folder. |
...
| demo | 2 | Reset demo |
| demo | 3 | Start for real |
| demo | 2 | Caption Cues |
| demo | 1 | Demo |
| demo | 3 | How it works |
| demo | 1 | Privacy |
| demo | 2 | Download ZIP |
| demo | 2 | Isolated sample |
| demo | 6 | Try Caption Cues on sample captions |
| demo | 15 | Change the marks, add a saved word, and replay lines from a short station scene. |
| demo | 5 | Sample player · Thessaly station |
| demo | 4 | Line 1 of 3 |
| demo | 8 | MARA: Rowan, wait at Thessaly Gate. [train approaching] |
| demo | 2 | Previous line |
| demo | 4 | Replay last line Alt+R |
| demo | 2 | Next line |
| demo | 7 | Sample ready. Caption line 1 is highlighted. |
| demo | 4 | Choose what stands out |
| demo | 2 | Speaker labels |
| demo | 4 | Text before the colon |
| demo | 1 | Names |
| demo | 4 | Names in each line |
| demo | 2 | Sound cues |
| demo | 3 | Descriptions in brackets |
| demo | 2 | Saved words |
| demo | 4 | Your own word list |
| demo | 4 | Add a saved word |
| demo | 2 | Save word |
| demo | 3 | Saved word: Gate |
| demo | 2 | Caption size |
| demo | 1 | Comfortable |
| demo | 1 | Large |
| demo | 2 | Extra large |
| demo | 2 | Caption background |
| demo | 1 | Paper |
| demo | 2 | Night ink |
...
| popup | 3 | Enable Caption Cues |
| popup | 3 | Checking this page… |
| popup | 4 | What should stand out? |
| popup | 1 | Names |
| popup | 7 | Capitalized names such as Mina or Calder |
| popup | 2 | Speaker labels |
| popup | 4 | Labels before a colon |
| popup | 2 | Sound cues |
| popup | 4 | Bracketed cues like [doorbell] |
| popup | 3 | My saved words |
| popup | 4 | Your own easy-to-miss words |
| popup | 2 | Saved words |
| popup | 6 | Add a word or short phrase |
| popup | 2 | Save word |
| popup | 9 | None yet. Try a character name or a place. |
| popup | 2 | Caption display |
| popup | 2 | Text size |
| popup | 1 | Comfortable |
| popup | 1 | Large |
| popup | 2 | Extra large |
| popup | 2 | Caption background |
| popup | 1 | Paper |
| popup | 2 | Night ink |
...
| README | 2 | npm ci |
| README | 3 | npm run setup:browser |
| README | 3 | npm run check |
| README | 7 | On Ubuntu CI, use npm run setup:browser:ci. |
| README | 3 | Optional CI command: |
| README | 3 | npm run check:clean-browser |
| README | 6 | Every public claim appears in .factory/claims.json. |
| README | 10 | Run one claim with the exact command in that file. |
| README | 4 | Run them all with: |
| README | 3 | npm run test:claims |
| README | 10 | After deployment, run npm run verify:live against the production origin. |
| README | 3 | Build and load |
| README | 3 | npm run build:site |
| README | 7 | Build output is in dist/extension and dist/site. |
...
| --- | --- |
| Name before a colon | speaker label |
